...
while True:
    ...
    match mess.upper():
        ...
        case "ЦЕНА ДОМ-1": print(f"Сейчас цена 1-этажного дома составляет {h_price_1}")
        ...
        case "ЦЕНА ДОМ-3": print(f"Сейчас цена 3-этажного дома составляет {h_price_2}")
        ...
        case "ЦЕНА ДОМ-5": print(f"Сейчас цена 5-этажного дома составляет {h_price_3}")
